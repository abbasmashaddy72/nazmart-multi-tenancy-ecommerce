...
{{--//                            dd($original_title, $description, $button_text, $button_url, $right_image);--}}
{{--                        @endphp--}}
