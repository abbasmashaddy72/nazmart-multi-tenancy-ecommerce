...
<tr>
    ...
    <td>
        <input value="{{ $classOption->tax_name ?? "" }}" type="text" name="tax_name[]" required>
    </td>
    <td>
    ...
    <td>
        <input value="{{ $classOption->postal_code ?? "" }}" type="text" name="postal_code[]" id="postal_code">
    </td>
    <td>
        <input value="{{ $classOption->rate ?? '0.00' }}" type="number" name="rate[]" step="0.01" id="rate" required
               pattern="[A-Za-z0-9]{5}">
    </td>
    <td class="d-none">
    ...
    <td>
        <input value="{{ $classOption->priority ?? "" }}" type="number" name="priority[]" id="priority" required>
    </td>
</tr>